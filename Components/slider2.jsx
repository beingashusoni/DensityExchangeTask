      ...
      >
        ...
        <Flex flexDirection="column">
          ...
          >
            ...
            <Text>
              And bad behavior die hard. Fortunately,we give you great, science-backend technique to use.
            </Text>
          </Box>
          ...
          >
            <Text color="black" fontSize="20px" fontWeight="bold" mb="13px">
              You and your motivation don't have a long-term realtionship
            </Text>
            <Text>
              Luckily, we can proactively prepare you for the marathon not just the race. Effective memorable exrecisewill help you stick to your goals.
            </Text>
          </Box>

          <Box className="slide" style={{ marginTop: "60px" }}>
            <Text color="black" fontSize="20px" fontWeight="bold" mb="13px">
              Books just don't offer practical solutions.
            </Text>
            <Text>
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae at iure libero reiciendis molestias esse fugiat aliquam autem nemo tempore!
            </Text>
          </Box>
        </Flex>
      </Flex>
